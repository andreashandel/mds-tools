...
* Perform a basic Git workflow using GitHub Desktop
* Understand the concept of branches
* Understand the concept of forks and pull requests
:::
...
[**GitHub**](https://github.com/) is distinct from Git. **GitHub** is mainly an online platform that hosts changes you make and track with Git in the cloud. This makes collaboration and sharing easy. GitHub is basically a web platform where you can store your projects in the cloud.  
