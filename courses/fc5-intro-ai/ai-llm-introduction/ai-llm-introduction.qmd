...
View the slide deck for this unit: [Slides](ai-llm-introduction-slides.qmd){target="_blank" rel="noopener"}
...
AI tools can be very useful tools to help you write code and do your data analysis. It is useful to think about what AI tools are and how to interact with them. It is always important to keep in mind the risks and limitations of any tool, including AI.
