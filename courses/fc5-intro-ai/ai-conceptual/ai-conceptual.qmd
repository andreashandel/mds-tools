...
<iframe class="video" src="https://www.youtube.com/embed/VIDEO_ID" title="Conceptual ways to think about AI" allowfullscreen></iframe>
...
```{r ai-conceptual-quiz}
#| echo: false
#| results: "asis"
quizzes <- list("ai-conceptual-quiz-1.Rmd", "ai-conceptual-quiz-2.Rmd", "ai-conceptual-quiz-3.Rmd")
exams2forms::exams2forms(file = quizzes, title = 'ai-conceptual-quiz')
```
:::
<!-- end unit-quiz div -->
...
* Write one prompt using the "AI as intern" framing and one using the "brainstorming partner" framing.
* Pick a current task and decide which conceptual framing best fits it.
* Discuss with a peer whether the "AI as electricity" analogy resonates or not.
