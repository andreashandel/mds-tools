...
Artificial Intelligence (AI) is definitely a trendy topic these days. It is widely used and also widely mis-used in many contexts these days. Roughly speaking, AI is the use of complex models, usually NN. If one wanted to differentiate DL and AI, one might say that AI is the use of DL approaches applied to problems. However, it seems these days that DL and AI are terms that are used largely interchangeably. Overall, if you hear AI or DL, you can think of it roughly as *fitting a complex (usually neural net) model to data.* Unfortunately, since DL and AI have become such *hot* topics, terms are often applied to a lot of different instances. And the use of LLM AI tools to help with various tasks further muddles what AI actually is. 
