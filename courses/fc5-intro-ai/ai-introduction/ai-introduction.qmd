...
View the slide deck for this unit: [Slides](ai-introduction-slides.qmd)
...
Read the text transcript: [Text transcript](ai-introduction-transcript.md)
...
Progress in AI will continue to be rapid and lead to many important advances. With everything "new and shiny" there comes a good bit of hype. The goal for this short unit is to give you a very brief introduction to what you should think of when you hear AI, how AI is related to data analysis/machine learning, and how you could -- if you wanted -- do AI yourself.
...
Artificial Intelligence (AI) is definitely a trendy topic these days. It is widely used and also widely misused in many contexts these days. Roughly speaking, AI is the use of complex models, usually NN. If one wanted to differentiate DL and AI, one might say that AI is the use of DL approaches applied to problems. However, it seems these days that DL and AI are terms that are used largely interchangeably. Overall, if you hear AI or DL, you can think of it roughly as *fitting a complex (usually neural net) model to data.* Unfortunately, since DL and AI have become such *hot* topics, terms are often applied to a lot of different instances. And the use of LLM AI tools to help with various tasks further muddles what AI actually is. 
...
Overall, DL and AI are certainly very promising approaches and will undoubtedly lead to significant improvements -- or at least changes -- in many areas of our lives. 
...
The [RStudio/Posit TensorFlow website](https://tensorflow.rstudio.com/) has a lot of good information and documentation on how to use Keras through R to do DL/AI. Starting there with the *Tutorials* section is probably the best way to get going. After that you can branch out to some of the other resources. While I'm sure a DL/AI expert uses more than just Keras/TensorFlow as tools, you can get very far with those. And for playing around with DL/AI, Keras through R is a great place to start. 
...
This unit provided a brief introduction to neural networks, deep learning, and how those ideas fit under the AI umbrella. It also highlighted that R can interface with tools like TensorFlow and Keras, though it may not be the best option for heavy AI work.
...
If you want to learn more about neural nets, the [Wikipedia entry](https://en.wikipedia.org/wiki/Artificial_neural_network) is a good place to start. 
...
The [StatQuest YouTube Channel](https://www.youtube.com/@statquest) has some great videos explaining neural networks and deep learning in an easy-to-understand way.
...
```{r ai-introduction-quiz}
#| echo: false
#| results: "asis"
quizzes <- list("ai-introduction-quiz-1.Rmd", "ai-introduction-quiz-2.Rmd", "ai-introduction-quiz-3.Rmd")
exams2forms::exams2forms(file = quizzes, title = 'ai-introduction-quiz')
```
:::
<!-- end unit-quiz div -->
...
* Watch at least one StatQuest video on an AI topic of interest.
* Look at the examples on the RStudio/Posit TensorFlow website and try to reproduce one of them.
