...
* Skim the Wikipedia pages on neural networks and deep learning and note one key difference.
* Browse the TensorFlow or Keras R tutorials and identify a starter example you could run later.
* Reflect on one problem where a simple model might beat an overly complex AI approach.
