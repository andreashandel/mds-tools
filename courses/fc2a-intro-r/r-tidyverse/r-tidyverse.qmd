...
In the prior unit, we discussed R packages, what they are and how to install them. This unit focuses on a few R collections of R packages that are widely used for modeling and data science work.
...
In general, packages inside tidyverse focus on data cleaning, processing and visualization. 
...
The [`tidymodels`](https://www.tidymodels.org/) collection of R packages is very similar in concept and philosphy to the `tidyverse` set of packags, but it is designed for modeling and machine learning tasks. Similar to the tidyverse, the packages that make up tidymodels share common design philosophies and are intended to work together seamlessly.
