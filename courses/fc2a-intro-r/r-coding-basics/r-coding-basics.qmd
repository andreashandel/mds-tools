...
View the slide deck for this unit: [Slides](r-coding-basics-slides.qmd)
...
Read the text transcript: [Text transcript](r-coding-basics-transcript.md)
...
3.  Someone has had the same problem before and written about it on the
    ...
    Search like you’d write a function call, not a sentence, and it should
