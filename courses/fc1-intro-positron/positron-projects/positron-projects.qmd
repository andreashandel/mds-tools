...
View the slide deck for this unit: [Slides](positron-projects-slides.qmd)
...
Read the text transcript: [Text transcript](positron-projects-transcript.md)
...
<!-- ai-figure: projects -->
![](media/projects.png){fig-alt="Illustration related to Projects." fig-cap="Illustration related to Projects."}
<!-- end-ai-figure -->
...
<!-- ai-figure: projectsinpositron -->
![](media/projectsinpositron.png){fig-alt="Illustration related to Projects in Positron." fig-cap="Illustration related to Projects in Positron."}
<!-- end-ai-figure -->
...
<!-- ai-figure: projectcreationinpositron -->
![](media/projectcreationinpositron.png){fig-alt="Illustration related to Project creation in Positron." fig-cap="Illustration related to Project creation in Positron."}
<!-- end-ai-figure -->
...
<!-- ai-figure: projectuseinpositron -->
![](media/projectuseinpositron.png){fig-alt="Illustration related to Project use in Positron." fig-cap="Illustration related to Project use in Positron."}
<!-- end-ai-figure -->
