...
View the slide deck for this unit: [Slides](positron-use-slides.qmd)
...
Read the text transcript: [Text transcript](positron-use-transcript.md)
...
<!-- ai-figure: editingatextfile -->
![](media/editingatextfile.png){fig-alt="Illustration related to Editing a text file." fig-cap="Illustration related to Editing a text file."}
<!-- end-ai-figure -->
...
<!-- ai-figure: editingandrunningcode -->
![](media/editingandrunningcode.png){fig-alt="Illustration related to Editing and running code." fig-cap="Illustration related to Editing and running code."}
<!-- end-ai-figure -->
...
Finally, save the file as `.qmd` file.
...
* [Positron Keyboard shortcuts](https://positron.posit.co/keyboard-shortcuts.html) - if you are one of those persons who prefers to use keyboard shortcuts instead of the mouse, check out this handy reference. Note that these are just a few basic ones, almost everything can be turned into a keyboard shortcut.
...
::: {.unit-exercise}
# Practice
* Start a new text file. Use [Markdown Syntax](https://quarto.org/docs/authoring/markdown-basics.html) to write a bit of text. You should see Positron do syntax highlighting for Markdown. Save the file as `myfirstfile.md`. For now, you can't preview it unless you have Quarto (or some other extension) installed. You can try that later once you have Quarto up and running.
