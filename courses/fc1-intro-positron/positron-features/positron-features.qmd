...
This unit familiarizes you with Positronâ€™s basic layout and features. 
...
The bottom-right area is usually the Viewer pane. It automatically displays plots created by code, such as Râ€™s *ggplot2*, Pythonâ€™s *matplotlib*, or Juliaâ€™s *Plots* package. HTML widgets, data frames, interactive tables, and other items that can be previewed appear there. If you set Quarto to internal preview (the default), rendered Quarto documents will also show there. 


## Environment and History Pane


The topâ€‘right pane shows your workspace objects/variables. Click any variable to further inspect it. 
