...
View the slide deck for this unit: [Slides](positron-extensions-slides.qmd)
...
Read the text transcript: [Text transcript](positron-extensions-transcript.md)
...
In many programming languages, a lot of extra functionality comes from libraries or packages. In editors like Positron (and VS Code and others), the equivalent of packages are _extensions_ (another term sometimes used is _plugins_). 


## Managing Extensions

<!-- ai-figure: managingextensions -->
![](media/managingextensions.png){fig-alt="Illustration related to Managing Extensions." fig-cap="Illustration related to Managing Extensions."}
<!-- end-ai-figure -->
