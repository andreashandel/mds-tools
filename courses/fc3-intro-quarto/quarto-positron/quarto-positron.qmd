...
View the slide deck for this unit: [Slides](quarto-positron-slides.qmd){target="_blank" rel="noopener"}
...
Read the text transcript: [Text transcript](quarto-positron-transcript.md)
...
* The [Quarto section of the Positron documentation](https://positron.posit.co/) has more details on using Quarto within Positron.
* The [Quarto website](https://quarto.org/) provides comprehensive documentation on all Quarto features.
