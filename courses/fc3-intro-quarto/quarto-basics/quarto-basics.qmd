...
View the slide deck for this unit: [Slides](quarto-basics-slides.qmd)
...
Read the text transcript: [Text transcript](quarto-basics-transcript.md)
...
::: {.unit-exercise}
# Practice
* Create a new Quarto document Go to the Quarto website [authoring section](https://quarto.org/docs/authoring/markdown-basics.html) and implement some of the features explained there.
* As you play with your Quarto document, keep previewing it, and keep switching between `Source` and `Visual` mode in the editor.
