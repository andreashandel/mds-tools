...
View the slide deck for this unit: [Slides](quarto-introduction-slides.qmd){target="_blank" rel="noopener"}
...
Read the text transcript: [Text transcript](quarto-introduction-transcript.md)
...
Occasionally, you might still need to use R Markdown, and you will find a lot of online information for R Markdown. Since Quarto is an evolution of R Markdown and shares many similarities, often what works in R Markdown will also work in Quarto.
